  ...
  return (
    <div className="container">
      ...
      <section className="about-section">
        ...
        <p>
          طرح مهارت‌آموزی در خدمت سربازی با هدف افزایش توانمندی نیروهای وظیفه در راستای ورود مؤثر به بازار کار پس از پایان خدمت طراحی شده است. این برنامه با همکاری سازمان فنی و حرفه‌ای کشور و مرکز مهارت آموزی شهید باقری اجرا می‌شود.
        </p>
        <p>
      ...
      <footer className="footer">
        © {new Date().getFullYear()} مرکز مدیریت مهارت آموزی شهید باقری
      </footer>
    </div>
  );
}
